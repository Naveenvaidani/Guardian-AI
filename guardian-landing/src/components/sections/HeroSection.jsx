      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <button className="group relative inline-flex items-center gap-2 overflow-hidden rounded-xl bg-guardian-navy px-8 py-4 text-sm font-bold text-white shadow-lg transition-all hover:bg-[#0F2A4D] hover:scale-[1.02] active:scale-[0.98]">
              Start Analyzing
