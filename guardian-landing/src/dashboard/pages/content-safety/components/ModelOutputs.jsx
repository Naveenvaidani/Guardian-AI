  ...
  return (
    <div className="flex flex-col gap-6 h-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* Biometric */}
        <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm flex flex-col items-center text-center relative overflow-hidden backdrop-blur-md">
        ...
        {/* Liveness */}
        <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm flex flex-col items-center text-center relative backdrop-blur-md">
        ...
        {/* Deepfake */}
        <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm flex flex-col items-center text-center backdrop-blur-md">
          <div className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center mb-3 border border-slate-100">
