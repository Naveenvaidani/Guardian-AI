...
import { Shield, Bell, LayoutDashboard, Activity, AlertTriangle, Gavel, Baby, Zap, Settings, ChevronDown } from 'lucide-react';
    ...
    <nav className="w-full bg-white/70 border-b border-slate-200 backdrop-blur-xl px-6 py-4 flex items-center justify-between">
      <div className="flex items-center gap-6">
        ...
        <div className="flex flex-col justify-center">
          <h1 className="text-2xl font-black text-slate-900 tracking-tight leading-tight">Content Restriction System</h1>
      ...
      <div className="hidden xl:flex items-center gap-6">
        ...
        <a href="#" className="flex items-center gap-2 text-slate-500 font-medium hover:text-fraud-cyan transition-colors">
          <Baby className="w-4 h-4" /> Child Safety
        </a>
        <a href="#" className="flex items-center gap-2 text-fraud-cyan font-bold transition-colors">
